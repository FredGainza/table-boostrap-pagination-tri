...
*/
    ...
    echo '<select name="nb_items" id="nb_items" class="form-control form-control-lg pad-r-0 custom-select">';
    ...
    echo '<div class="row align-items-center justify-content-end mr-5">';
    ...
    for ($i = 0; $i < count($columns); $i++) {
        ...
        echo '><a href="?nb_items=' . $limit . '&page=' . $page . '&column=';
